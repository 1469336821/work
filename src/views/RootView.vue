<template>
  <div class="root">
    ...
    <div class="nav">
      <!-- 账号 -->
      <div class="info">欢迎管理员: {{ userInfo.user }}</div>
      <!-- 标题 -->
    ...
    <div class="content">
      ...
      <div class="left">
        ...
        <div @click="jump6()" class="left-title" :class="{ bg: bool6 }">
          <div class="icon">
            <el-icon :size="20"><files /></el-icon>
          </div>
          <div class="text">
...
export default {
  ...
  methods: {
    ...
    //用户查询
    jump2() {
      this.$router.push("/root/view2");
      this.clear();
      this.bool2 = true;
    },
    //作业查询
    jump3() {
      this.$router.push("/root/view3");
      this.clear();
      this.bool3 = true;
    },
    //修改信息
    jump4() {
      this.$router.push("/root/view4");
      this.clear();
      this.bool4 = true;
    },
    //退出登录
